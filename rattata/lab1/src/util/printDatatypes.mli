...
val assemBinopToString : assemBinop -> string
val assemInstrToString : assemInstr -> string
val assemProgToString : assemProg -> string (* add this to print *)
val tmpToString : tmp -> string
val tmpAssemLocToString: tmpAssemLoc -> string
...
val tmpWonkyInstrToString : tmpWonkyInstr -> string
val tmpWonkyProgToString : tmpWonkyProg -> string
