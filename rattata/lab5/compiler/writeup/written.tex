...
\usepackage[utf8]{inputencepackage{graphicx}
...
\includegraphics[scale=0.1]{everything-page-001}
...
\includegraphics[scale=0.1]{O1_vs_deadcode-page-001}
...
\includegraphics[scale=0.1]{O1_vs_constOpts-page-001}
...
\includegraphics[scale=0.1]{allocating_more_regs-page-001}
...
\includegraphics[scale=0.1]{O1_vs_inlining-page-001}
